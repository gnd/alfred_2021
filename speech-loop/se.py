...
FULL_SCREEN = bool(get_env("OKC_MAIN_HAS_FULLSCREEN", ""))
...
class App:
    def __init__(self, speech_lang=SPEECH_LANG, reset_pause=PAUSE_LENGTH):
        ...
        self.dm = DisplayManager(self, self.display, top_bottom_split=not FULL_SCREEN, padding=(DEFAULT_PADDING_TOP, DEFAULT_PADDING_LEFT))
